...
class MainWindow(QMainWindow):
    ...
    def setUpBody(self):
        ...
        self.file_manager = FileManager(
            tab_view=self.tab_view, set_new_tab=self.set_new_tab, main_window=self)  # was tree_view
        ...
        search_layout.addSpacerItem(
            QSpacerItem(5, 5, QSizePolicy.Policy.Minimum,
        ...
        folder_label = self.get_sidebar_button(
            "./src/icons/folder-icon-blue.svg", self.file_manager_frame
        )
        side_bar_content.addWidget(folder_label)
        search_label = self.get_sidebar_button(
            "./src/icons/search-icon.svg", self.search_frame)
    ...
    def show_dialog(self, title, msg) -> int:
        ...
        dialog.setWindowIcon(QIcon("./src/icons/close-icon.svg"))
        dialog.setText(msg)
    ...
    def close_tab(self, index: int):
        ...
        if editor.current_file_changed:
            dialog = self.show_dialog(
                "Close", f"Do you want to save the changes made to {
    ...
    def open_folder(self):
        ...
        if new_folder:
            ...
            self.file_manager.setRootIndex(
                self.file_manager.model.index(new_folder))
