                    ...
                    try:
                        font = QFont(
                            ...
                            self.font_weights.get(
                                v.get('font-weight', QFont.Weight.Normal)),
                            v.get('italic', False),
                        )
                        self.setFont(
                            font,
...
class PyCustomLexer(DragonLexer):
